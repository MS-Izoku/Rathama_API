...
class SeedsController < ApplicationController
  ...
  def seed_all
    ...
    @failed = nil
    {
      ...
      @failed = { name:, error: e.message, full_error: e }
      break
    end
    ...
    render json: { message: 'Seeding process failed', error: e.message, completed: @completed, failed: @failed, full_error: e },
  ...
  def seed_tribes_and_spell_schools
    ...
    render json: { message: 'Failed to seed Tribes and Spell Schools', error: e.message, full_error: e },
           status: :internal_server_error
  end
  ...
  def seed_spell_schools
    ...
    render json: { message: 'Failed to seed Spell Schools', error: e.message, full_error: e },
           status: :internal_server_error
  end
    # endregion
  ...
  def seed_basic_cards
    ...
    render json: { message: 'Failed to seed Basic Cards', error: e.message, full_error: e },
           status: :internal_server_error
  end
    # endregion
  ...
  def seed_card_mechanics
    ...
    render json: { message: 'Failed to seed Card Mechanics', error: e.message, full_error: e },
           status: :internal_server_error
  end
    # endregion
end
